    ...
    <section className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 md:py-32 max-w-7xl mx-auto gap-12 overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-start space-y-6">
        ...
        <p className="text-gray-400 text-lg leading-relaxed max-w-xl text-pretty">
          Estudiante avanzado de Ingeniería en Sistemas con enfoque en
          desarrollo de software y programación. Poseo sólidos conocimientos en
          bases de datos relacionales (SQL Server, MySQL) y dominio de lenguajes
          como C#, Python y JavaScript, así como conocimiento en frameworks
          modernos como React, Next.js y Django. Me caracterizo por ser una
          persona autodidacta, proactiva y orientada a la resolución de
          problemas, con interés constante en el aprendizaje y adopción de
          nuevas tecnologías.
        </p>
